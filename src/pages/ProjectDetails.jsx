...
export function ProjectDetails() {
  ...
  const galleryImages = [
    {
      src: "/projectDetails/image2.png",
      alt: "Kitchen",
      span: "md:col-span-1"
    },
    {
      src: "/projectDetails/image3.png",
      alt: "Bathroom",
      span: "md:col-span-1"
    },
    {
      src: "/projectDetails/image1.png",
      alt: "Dining Area",
      span: "md:col-span-2"
    },
    { src: "/projectDetails/image4.png", alt: "Stairs", span: "md:col-span-3" },
    { src: "/projectDetails/image5.png", alt: "Sink", span: "md:col-span-3" },
    { src: "/projectDetails/image6.png", alt: "Sink", span: "md:col-span-3" }
  ];
  return (
    <div className="bg-background2">
      {/* Image Section */}
      <div className=" relative bg-background2">
      ...
      {/* details */}
      <section className="container w-full mx-auto px-8 py-8 lg:py-24">
        <div className="flex flex-col pt-8 px-8 lg:flex-row gap-16 lg:gap-24 items-stretch justify-between">
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
            {[1, 2].map(i =>
              <div
                key={i}
                className="h-full overflow-hidden rounded-lg shadow-xl"
              >
                <img
      ...
      {/*gallery  */}
      <section className="bg-background2 container mx-auto py-12 lg:py-24">
        <div className="mt-8 relative bg-background2">
          <img
            src="/projectDetails/image6.png"
            alt="Modern living room interior design"
            className="w-full h-auto object-cover rounded-lg shadow-xl"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8">
          {galleryImages.map((image, index) =>
            <div
              key={index}
              className={`overflow-hidden rounded-xl shadow-lg ${image.span}`}
            >
              <img
                src={image.src}
                alt={image.alt}
