            ...
            <div className="w-1/3">
              ...
              <ul className="space-y-6">
                {services.map((service, index) => (
                  <li
                    key={index}
                    className="text-xl border-b-2 border-gray-300 text-[var(--text-secondary)] pb-4 last:pb-0"
                  >
                    {service}
                  </li>
                ))}
            ...
            <div className="flex  flex-col lg:flex-row items-center lg:items-stretch gap-12">
              ...
              <div className="lg:w-1/3 w-full p-4 lg:p-8">
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  Laborum ullamco id non excepteur aliqua ea cillum et
                  reprehenderit. Cupidatat ex dolore amet mollit voluptate culpa
                  et est
                </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.map((project, index) => (
                ...
                >
                  <a href="#">
                    {" "}
                    {/* Link wrapping the image and text */}
                    <img
